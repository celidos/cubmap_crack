...
# 		)
		self.aux_heads_serial = nn.ModuleList([
			AUXheadHR(in_channels=152, mid_channels=320, out_channels=n_classes, upsample=4),
			AUXheadHR(in_channels=320, mid_channels=320, out_channels=n_classes, upsample=8),
			AUXheadLR(in_channels=320, mid_channels=320, out_channels=n_classes, pix_shuffle=2, upsample=8),
			AUXheadLR(in_channels=320, mid_channels=320, out_channels=n_classes, pix_shuffle=4, upsample=8),
		])
